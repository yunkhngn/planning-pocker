...
export function Home() {
    ...
    const handleCreateRoom = async (e: React.FormEvent) => {
        ...
        try {
            ...
            alert("Firebase is not configured! Mocking navigation for UI preview.");
                    ...
                    <CardContent>
                        <form onSubmit={handleCreateRoom} className="space-y-4">
                            <div className="space-y-2 text-left">
                                <label htmlFor="roomName" className="text-sm font-medium text-slate-700">Game's name</label>
                                <Input
                                    id="roomName"
                            ...
                            <div className="space-y-2 text-left">
                                <label htmlFor="userName" className="text-sm font-medium text-slate-700">Your name</label>
                                <Input
                                    id="userName"
